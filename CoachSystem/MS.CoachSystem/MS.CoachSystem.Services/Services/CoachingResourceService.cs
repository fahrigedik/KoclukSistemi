...
public class CoachingResourceService : GenericService<CoachingResource, CoachingResourceDto>, ICoachingResourceService
{
    ...
    public CoachingResourceService(IGenericRepository<CoachingResource> _repository, IMapper _mapper, IUnitOfWork _unitOfWork) : base(_repository, _mapper, _unitOfWork)
    {
